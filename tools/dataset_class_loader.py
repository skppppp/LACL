...
class MashupDataset(Dataset):
    def __init__(self, all_api=False, plus=0.7, api_threshold=1647):
        super().__init__()
        ...
        for i in range(len(self.used_api)):
            ...
            # delete_link = random.choice(api_ids[0])
...
class ApiDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        return torch.tensor(index).long(), \
               ...
               category_tensor, \
               used_api_tensor, \
               des_len, category_token, self.categ[index], self.des[index]
...
class TextDataset:
    def __init__(self, mul=1, plus=0.7):
        cache = '.vec_cache'
        ...
        self.mashup_ds = MashupDataset(all_api=True, plus=plus, api_threshold=self.API_THRESHOLD)
